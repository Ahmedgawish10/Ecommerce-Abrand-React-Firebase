            ...
            <nav className={`${isDarkMode ? "bg-[#030302]" : "bg-white"} border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800`} mobile-menu-2="2" >
                ...
                ${isMenuOpen ? 'active-menu' : ''}`} id="mobile-menu-2">
                        <ul className="flex flex-col md:flex-row   font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="#" className="block py-2 md:pr-2 lg:mr-4 pl-3  border-b md:border-b-0 border-gray-100 lg:border-0  lg:p-0">Company</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 md:pr-2 lg:mr-4 pl-3  border-b md:border-b-0 border-gray-100 lg:border-0  lg:p-0">Categories</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 md:pr-2 lg:mr-4 pl-3  border-b md:border-b-0 border-gray-100 lg:border-0  lg:p-0">Deals</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 md:pr-2 lg:mr-4 pl-3  border-b md:border-b-0 border-gray-100 lg:border-0  lg:p-0">Contact Us</a>
                            </li>
                        </ul>
                    </div>
