...
import { collection, addDoc,setDoc,doc ,  getDocs, updateDoc, getDoc, query, where } from "firebase/firestore";
...
console.log(auth.currentUser?.uid);
    ...
    useEffect(() => {
        ...
        if (userAuth && localStorage.getItem("authenticated")=="true") {
    ...
    if ( userAuth && Object.keys(userAuth).length > 0 && userAuth && localStorage.getItem("authenticated")=="true") {
        // return
    }
...
// get user is logged in now and check if user authenticated?
const getCurrentUser = async () => {    
    ...
    try {
      ...
      const users = querySnapshot.docs.map((doc) => {
       ...
       console.log(FirbaseUser.auth);
       
    if (FirbaseUser.auth=="authenticated") {
        setAuth(FirbaseUser.auth)

    toast.success("Already loggddded in");
                    //    navigate("/", { replace: true });
                ...
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                        ...
                        <div className="hidden lg:relative lg:block lg:p-12">
                            ...
                            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl" onClick={()=>updateMovieTitle("5yBHIVUPXdckFRNTKdKe")}>
                                Welcome to Sheind
                            </h2>
