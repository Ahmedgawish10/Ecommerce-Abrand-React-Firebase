...
export default function Auth() {
  ...
  return (
    <div className="register-section">
      {auth.currentUser && localStorage.getItem("isAuthenticated") ? (
        <Navigate replace to="/" />
      ) : (
        <section className="">
          <div className="lg:grid lg:min-h-creen lg:grid-cols-12">
            <section className=" hidden relative lg:flex items-end bg-gray-900 lg:col-span-5 h-[calc(100vh-112px)] xl:col-span-6">
              ...
              <div className="hidden lg:relative lg:block lg:p-12">
                ...
                Discover the finest products, handpicked for you. Shop quality, shop style, shop effortless.
                </p>
              </div>
            </section>
                  ...
                  <div className="col-span-6 sm:flex  flex-col sm:gap-4">
                    ...
                    >
                      {registerSpiner ? (
                        ...
                        <div className="w-[100%]">Register</div>
                      )}
                    </button>
                    <div className="provider flex gap-4 xs:flex-col xs:gap-0 mt-2">
                      <button
                        ...
                        className="mt-3  xs:flex xs:justify-center text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2"
                      >
                      ...
                      <button
                        type="button"
                        className="mt-3 xs:flex xs:justify-center text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2"
                      >
                        <svg
